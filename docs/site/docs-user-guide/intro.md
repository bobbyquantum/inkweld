...
id: intro
title: User Guide
description: Complete guide to using Inkweld for collaborative creative writing.
slug: /
sidebar_position: 1
---
...
Inkweld is a collaborative creative writing platform designed for authors, worldbuilders, and storytellers. Whether you're writing a novel solo, collaborating with co-authors, or building an expansive fictional universe, Inkweld provides the tools you need to bring your stories to life.
...
Ready to dive in? Here's the fastest path to writing:

1. **Create an account** or log in at your Inkweld instance
2. **Click "New Project"** on your dashboard
3. **Enter a title** and create your project
4. **Start writing** in the default Chapter 1 document

That's it! Inkweld handles saving automatically, and your work syncs across all your devices.
...
- Check the [Troubleshooting](/docs/troubleshooting/logging) section in the main documentation
- Visit the [GitHub Discussions](https://github.com/bobbyquantum/inkweld/discussions) for community support
- Report bugs on the [GitHub Issues](https://github.com/bobbyquantum/inkweld/issues) page
