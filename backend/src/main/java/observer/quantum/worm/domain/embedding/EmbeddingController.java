package observer.quantum.worm.domain.embedding;
...
@Tag(
    name = "Embedding API",
    description = "The embedding controller supports generating text embeddings using Ollama.")
public class EmbeddingController {
  ...
  @Operation(
      ...
      description =
          "Generates embeddings for a list of input texts using the Ollama model specified in the configuration. "
                        ...
                        @ArraySchema(
                            schema =
                                @Schema(
                                    ...
                                    description =
                                        "List of embedding vectors, each vector is an array of 384 float values")))),
        @ApiResponse(
            responseCode = "400",
  ...
  public ResponseEntity<List<List<Float>>> generateEmbeddings(
    ...
    logger.info(
        "Generated {} embedding vectors, each with {} dimensions",
        embeddings.size(),
