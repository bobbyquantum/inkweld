...
import observer.quantum.worm.project.ProjectService;
...
public class ProjectElementService {
    ...
    @Transactional
    public ProjectElementDto createElement(String username, String projectSlug, ProjectElementDto elementDto) {
    ...
    @Transactional
    public ProjectElementDto updateElement(String username, String projectSlug, String elementId, ProjectElementDto elementDto) {
        log.debug("Updating element {} in project {}/{}", elementId, username, projectSlug);
        Project project = projectService.findByUsernameAndSlug(username, projectSlug);
        ProjectElement element = elementRepository.findById(elementId)
        ...
        if (elementDto.getParentId() != null && !elementDto.getParentId().equals(element.getParentId())) {
