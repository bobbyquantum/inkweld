...
test.describe('Element Reference (@mentions)', () => {
  ...
  test('typing @ in editor triggers element search popup', async ({ page }) => {
    ...
    // Wait for the empty state using data-testid
    ...
    const popup = page.getByTestId('element-ref-popup');
    await expect(popup).toBeVisible();

    // Verify the search input is present
    const searchInput = page.getByTestId('element-ref-search-input');
  ...
  test('Escape key closes the @ mention popup', async ({ page }) => {
    ...
    await page.waitForURL(/\/testuser\/escape-test/);
  ...
  test('search query filters element results', async ({ page }) => {
    ...
    await page.waitForURL(/\/testuser\/search-test/);
  ...
  test('clicking result item closes popup', async ({ page }) => {
    ...
    await page.waitForURL(/\/testuser\/click-test/);
  ...
  test('keyboard navigation works in popup', async ({ page }) => {
    ...
    await page.waitForURL(/\/testuser\/keyboard-test/);
  ...
  test('element reference is rendered with proper styling', async ({
    ...
    await page.waitForURL(/\/testuser\/style-test/);
  ...
  test('right-click on element reference shows context menu', async ({
    ...
    await page.waitForURL(/\/testuser\/context-menu-test/);
  ...
  test('context menu edit mode allows changing display text', async ({
    ...
    await page.waitForURL(/\/testuser\/edit-test/);
    ...
    // Verify the text changed using expect() which auto-retries
    await expect(elementRef).toHaveText('My Custom Reference');
  ...
  test('context menu delete removes element reference', async ({ page }) => {
    ...
    await page.waitForURL(/\/testuser\/delete-test/);
    ...
    // Verify the element reference count decreased using expect() which auto-retries
    await expect(page.locator('.element-ref')).toHaveCount(
      elementRefsBefore - 1
    );
  });
});
