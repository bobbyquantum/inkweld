/**
 * Project Workflow Tests - Offline Mode
 *
 * Tests that verify project creation, management, and navigation
 * work correctly in pure offline mode without any server connection.
 */
import { expect, test } from './fixtures';

test.describe('Offline Project Workflows', () => {
  ...
  test('should persist project data in localStorage', async ({
    ...
    const projectsBefore = await page.evaluate(() => {
      return localStorage.getItem('inkweld-offline-projects');
    });
