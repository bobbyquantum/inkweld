...
export class LintingService extends BaseService {
  ...
  ): Observable<HttpResponse<LintStatus>>;
  public getLintStatus(
    observe?: 'events',
    reportProgress?: boolean,
    options?: {
  ...
  ): Observable<HttpEvent<LintStatus>>;
  public getLintStatus(
    observe: any = 'body',
    ...
    return this.httpClient.request<LintStatus>(
      'get',
  ...
  ): Observable<HttpResponse<LintResponse>>;
  public lintParagraph(
    lintRequest?: LintRequest,
    observe?: 'events',
    reportProgress?: boolean,
  ...
  ): Observable<HttpEvent<LintResponse>>;
  public lintParagraph(
    lintRequest?: LintRequest,
    observe: any = 'body',
    reportProgress: boolean = false,
    ...
    const { basePath, withCredentials } = this.configuration;
    return this.httpClient.request<LintResponse>(
      'post',
      `${basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
