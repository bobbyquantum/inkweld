...
export class ProjectsService extends BaseService {
   ...
   */
  public checkTombstones(
    checkTombstonesRequest?: CheckTombstonesRequest,
    observe?: 'body',
  ...
  ): Observable<CheckTombstonesResponse>;
  public checkTombstones(
    checkTombstonesRequest?: CheckTombstonesRequest,
    observe?: 'response',
    reportProgress?: boolean,
  ...
  ): Observable<HttpResponse<CheckTombstonesResponse>>;
  public checkTombstones(
    checkTombstonesRequest?: CheckTombstonesRequest,
    observe?: 'events',
    reportProgress?: boolean,
  ...
  ): Observable<HttpEvent<CheckTombstonesResponse>>;
  public checkTombstones(
    checkTombstonesRequest?: CheckTombstonesRequest,
    observe: any = 'body',
    ...
    return this.httpClient.request<CheckTombstonesResponse>(
      'post',
  ...
  public deleteProject(
    ...
    if (username === null || username === undefined) {
      throw new Error(
        'Required parameter username was null or undefined when calling deleteProject.'
      );
    }
  ...
  public getProject(
    ...
    if (username === null || username === undefined) {
      throw new Error(
        'Required parameter username was null or undefined when calling getProject.'
      );
    }
    if (slug === null || slug === undefined) {
      throw new Error(
  ...
  ): Observable<HttpResponse<ProjectStorageSize>>;
  public getProjectStorageSize(
    username: string,
    slug: string,
    observe?: 'events',
  ...
  ): Observable<HttpEvent<ProjectStorageSize>>;
  public getProjectStorageSize(
    username: string,
    slug: string,
    observe: any = 'body',
    ...
    if (username === null || username === undefined) {
      throw new Error(
        'Required parameter username was null or undefined when calling getProjectStorageSize.'
      );
    }
    if (slug === null || slug === undefined) {
      throw new Error(
        'Required parameter slug was null or undefined when calling getProjectStorageSize.'
      );
    }
    ...
    const { basePath, withCredentials } = this.configuration;
    return this.httpClient.request<ProjectStorageSize>(
      'get',
      `${basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public listUserProjects(    observe?: 'body',
    reportProgress?: boolean,
    options?: {
      httpHeaderAccept?: 'application/json';
      context?: HttpContext;
  ...
  public listUserProjects(
    ...
    let localVarPath = `/api/v1/projects`;
    const { basePath, withCredentials } = this.configuration;
    return this.httpClient.request<Array<Project>>(
      'get',
      `${basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
  ...
  public updateProject(
    ...
    if (username === null || username === undefined) {
      throw new Error(
        'Required parameter username was null or undefined when calling updateProject.'
      );
    }
    if (slug === null || slug === undefined) {
      throw new Error(
