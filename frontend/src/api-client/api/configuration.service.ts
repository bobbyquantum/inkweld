...
export class ConfigurationService extends BaseService {
  ...
  ): Observable<HttpResponse<ConfigResponse>>;
  public getAppConfiguration(
    observe?: 'events',
    reportProgress?: boolean,
    options?: {
  ...
  ): Observable<HttpEvent<ConfigResponse>>;
  public getAppConfiguration(
    observe: any = 'body',
  ...
  ): Observable<HttpResponse<SystemFeatures>>;
  public getSystemFeatures(
    observe?: 'events',
    reportProgress?: boolean,
    options?: {
  ...
  ): Observable<HttpEvent<SystemFeatures>>;
  public getSystemFeatures(
    observe: any = 'body',
    reportProgress: boolean = false,
    options?: {
    ...
    const { basePath, withCredentials } = this.configuration;
    return this.httpClient.request<SystemFeatures>(
      'get',
      `${basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
