...
export const APIS = [AIImageGenerationService, AIProvidersService, AITextGenerationService, AdminService, AdminConfigService, AdminImageProfilesService, AuthenticationService, ConfigurationService, DocumentsService, ElementsService, HealthService, ImageProfilesService, ImagesService, LintingService, MCPService, MCPKeysService, MediaService, ProjectsService, PublishedFilesService, SecurityService, ShareService, SnapshotsService, UsersService];
