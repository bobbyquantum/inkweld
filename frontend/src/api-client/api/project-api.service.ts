...
export class ProjectAPIService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public projectElementControllerDownloadImage(username: string, slug: string, elementId: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'image/*', context?: HttpContext, transferCache?: boolean}): Observable<object>;
    public projectElementControllerDownloadImage(username: string, slug: string, elementId: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'image/*', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<object>>;
    public projectElementControllerDownloadImage(username: string, slug: string, elementId: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'image/*', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<object>>;
    public projectElementControllerDownloadImage(username: string, slug: string, elementId: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'image/*', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (username === null || username === undefined) {
